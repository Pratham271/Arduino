...
const char* ssid = "Rahul";                //replace with our wifi ssid
const char* password = "hello@1234";         //replace with your wifi password

const char* host = "script.google.com";
const char *GScriptId = " AKfycbxFP9s_xDm-_mAtol03nMnkA-2ik_uRcjiyxGf3c9oUfglHJ_Q6X4bxemvFUyhuAq_J"; // Replace with your own google script id
...
void loop() {
  ...
  h = 75;                                              // Reading temperature or humidity takes about 250 milliseconds
  t = 35;                                           // Read temperature as Celsius (the default)
